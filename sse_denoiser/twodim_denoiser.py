...
class TwoDimDenoiserModel(torch.nn.Module):
    def __init__(self, residual=False, learn_static=False, return_attention=False, residual2=False, residual3=False):
        ...
        # Define layers
        self.conv1 = torch.nn.Conv2d(self.n_components, self.init_cnn_channels, kernel_size=(2, 2), stride=(2, 2), padding=0)
...
class TwoDimensionalDenoiser:
    ...
    def build(self):
        ...
        model = TwoDimDenoiserModel(residual=self.residual, learn_static=self.learn_static,
