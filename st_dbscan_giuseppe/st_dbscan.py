...
class ST_DBSCAN():
    ...
    def __init__(self,
                 ...
                 spatial_metric='haversine',
                 n_jobs=-1):
        self.eps1 = eps1
        self.eps2 = eps2
        self.min_samples = min_samples
        self.temporal_metric = temporal_metric
        # self.spatial_metric = lambda u, v: haversine_distances([u, v]) if spatial_metric == 'haversine' else spatial_metric
    ...
    def fit(self, X):
        ...
        if len(X) < 20000:
            ...
            euc_dist = squareform(pairwise_distances(X[:, 1:], metric=self.spatial_metric))  # squared -> condensed
